...
Functionality: Health check endpoint + demonstrates events layer integration by firing off event into event-bus.
...
Functionality: Demonstrates persistence layer functionality by connecting to the microservice database and creating a new order.
